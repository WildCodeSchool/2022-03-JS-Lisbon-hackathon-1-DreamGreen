    ...
    <div>
      {submitted ? (
        <div className="popup-main-container">
          ...
          <div className="form-info">
            ...
            <div>
              ...
              {`${schedule.date.substring(0, 10)}`} at{" "}
              {`${schedule.date.substring(11, 16)}`} hrs
            </div>
            {schedule.additional_information === "" ? null : (
              <div>
                Additional information:{`${schedule.additional_information}`}
              </div>
            )}
          </div>
        </div>
        ...
        <div>
          ...
          <form
            className="main-form justify-content-center"
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input
                  ...
                  {...register("oil_quantity", { required: true })}
                />
